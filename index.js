...
const database = firebase.database()
  ...
  function register () {
    ...
    if (validate_field(full_name) == false || validate_field(con_pass) == false || validate_field(city) == false) {
...
function checkCookie() {
    var UserName = getCookie("full_name");
    if(UserName != "") {
        alert("Welcome again, " + full_name);
    } else {
        firstName = prompt("Please enter your UserName:");
        if(UserName != "" && full_name != null) {
            getCookie("UserName", full_name, 30);
        }
   } 
}